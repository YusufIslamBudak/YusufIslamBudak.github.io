window.portfolioProfile = {
	...
	highlights: [
		...
		},
		{
			...
			description: 'C# ile geliştirilmiş stok takip uygulaması.', descriptionEn: 'Stock tracking application developed with C#.',
			meta: 'C#', url: 'https://github.com/YusufIslamBudak/c-sharp-proje'
		},
		{
			title: 'Gömülü Kodlar', titleEn: 'Embedded Codes',
			description: 'Embedded programming tarafında kullanılan kod ve yöntemler.', descriptionEn: 'Codes and methods used in embedded programming.',
	...
	certificates: [
		{
			title: 'CCNA: Anahtarlama, Yönlendirme ve Kablosuz Haberleşme Temelleri',
			titleEn: 'CCNA: Switching, Routing, and Wireless Essentials',
			issuer: 'Cisco',
			date: '01.05.2025',
			description: 'Cisco Networking Academy CCNA: Anahtarlama, Yönlendirme ve Kablosuz Haberleşme Temelleri sertifikası.',
		...
		{
			title: 'CCNA: Kurumsal Ağ, Güvenlik ve Otomasyon',
			titleEn: 'CCNA: Enterprise Networking, Security, and Automation',
			issuer: 'Cisco',
			date: '01.05.2025',
			description: 'Cisco Networking Academy CCNA: Kurumsal Ağ, Güvenlik ve Otomasyon sertifikası.',
		...
		{
			title: 'CCNA: Ağlara Giriş',
			titleEn: 'CCNA: Introduction to Networks',
			issuer: 'Cisco',
			date: '01.05.2025',
			description: 'Cisco Networking Academy CCNA: Ağlara Giriş sertifikası.',
		...
		},
		{
			...
			titleEn: 'Body Language Training',
			issuer: 'İstanbul Gedik Üniversitesi',
			date: '20.09.2024',
		...
		},
		{
			...
			titleEn: 'Leadership and Teamwork Training',
			issuer: 'İstanbul Gedik Üniversitesi',
			date: '20.09.2024',
		...
		},
		{
			...
			titleEn: 'Communication Techniques Training',
			issuer: 'İstanbul Gedik Üniversitesi',
			date: '20.09.2024',
		...
		},
		{
			...
			titleEn: 'TS EN ISO 9001:2015 Training',
			issuer: 'İstanbul Gedik Üniversitesi',
			date: '30.05.2023',
	...
	careerHistory: [
		...
		},
		{
			...
			descriptionEn: 'Supported administrative and technical processes at the university\'s Turkish Teaching Application and Research Center.'
		},
		{
			...
			descriptionEn: 'Participating in the quality and accreditation studies of the engineering faculty and preparing my university for the necessary audit processes.'
		},
		{
		...
		},
		{
			...
			descriptionEn: 'Managed operational processes ranging from basic operation requirements to workflow coordination, personnel training, and making managerial decisions.'
		}
	],
	articles: [
		{
		...
		},
		{
			...
			titleEn: 'GPS Data Stabilization at High Pressure and Altitude',
			publisher: 'TÜBİTAK 2209-A Projesi',
			publisherEn: 'TÜBİTAK 2209-A Project',
			date: '2023',
